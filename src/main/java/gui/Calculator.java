	...
	public void handle(ActionEvent event) {
		...
		String value = b.getText();
		 ...
		 if (Character.isDigit(value.charAt(0)) || value.equals(".")) {
		        // Si el botón presionado es un número o un punto decimal, agrega el valor al número actual
		        if (operator == null) {
		            number1 += value;
		        } else {
		            number2 += value;
	        ...
	        // Si el botón presionado es un operador, establece el operador y actualiza la pantalla
	        operator = value;
	        displayText.setText(displayText.getText() + " " + operator + " ");
	    } else if (value.equals("=")) {
	        // Si el botón presionado es '=', realiza la operación matemática y muestra el resultado
	        if (!number1.isEmpty() && !number2.isEmpty() && operator != null) {
		        ...
		        // Si el botón presionado es 'C', borra todo y reinicia la calculadora
		        number1 = "";
		        number2 = "";
		        operator = null;
		        displayText.setText("");
